...
public class NominaJobExecutionListener implements JobExecutionListener {

    private static final Logger LOGGER = LoggerFactory.getLogger(NominaJobExecutionListener.class);
